...
class InventoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        try {
            ...
            $inventories = Inventory::with(['productSku', 'warehouse'])->where('deleted_at', null);

            if (!CheckPermissionHelper::checkItHasPermission(['permission' => PermissionEnum::MELIHAT_INVENTORY, 'is_public' => $isPublic])) {
            ...
            return $this->successResponse("Berhasil Mendapatkan Data Inventory", 200, ['items'=>$inventories->paginate($perPage)]);
